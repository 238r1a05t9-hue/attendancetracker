...
class AppTheme {
  ...
  static const Color primaryLight = Color(0xFF009688); // Teal accent
  static const Color primaryVariantLight = Color(0xFF00695C); // Darker teal
  static const Color secondaryLight =
      Color(0xFF00695C); // Darker teal for secondary
  static const Color secondaryVariantLight =
      Color(0xFF004D40); // Even darker teal
  ...
  static const Color errorLight = Color(0xFFCF6679); // Material error
  static const Color successLight = Color(0xFF4CAF50); // Success green
  static const Color warningLight = Color(0xFFFF9800); // Warning orange
  static const Color onPrimaryLight = Color(0xFFFFFFFF); // White on teal
  static const Color onSecondaryLight = Color(0xFFFFFFFF); // White on secondary
  static const Color onBackgroundLight =
      Color(0xFF212121); // Dark text on light
  static const Color onSurfaceLight = Color(0xFF212121); // Dark text on surface
  static const Color onErrorLight = Color(0xFFFFFFFF); // White on error

  // Dark theme colors - Primary focus
  static const Color primaryDark = Color(0xFF009688); // Teal accent
  static const Color primaryVariantDark = Color(0xFF00695C); // Darker teal
  static const Color secondaryDark =
      Color(0xFF00695C); // Darker teal for secondary
  static const Color secondaryVariantDark =
      Color(0xFF004D40); // Even darker teal
  static const Color backgroundDark =
      Color(0xFF121212); // Material Design 3 dark
  static const Color surfaceDark =
      Color(0xFF1E1E1E); // Elevated cards and sheets
  static const Color errorDark = Color(0xFFCF6679); // Material error for dark
  ...
  static const Color onPrimaryDark = Color(0xFFFFFFFF); // White on teal
  static const Color onSecondaryDark = Color(0xFFFFFFFF); // White on secondary
  static const Color onBackgroundDark =
      Color(0xFFE0E0E0); // Primary text on dark
  static const Color onSurfaceDark =
      Color(0xFFFFFFFF); // Text on elevated surfaces
  static const Color onErrorDark = Color(0xFFFFFFFF); // White on error
  ...
  static const Color textMediumEmphasisDark =
      Color(0xFFBDBDBD); // Medium emphasis
  static const Color textDisabledDark = Color(0xFF757575); // Disabled state
  ...
  /// Dark theme - Primary focus for enterprise attendance management
